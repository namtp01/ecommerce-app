                            ...
                            <div>
                                ...
                                <div className='d-flex align-items-center gap-10'>
                                    <div className='form-floating'>
                                        <input className='form-control' id='floatingInput' placeholder='From' />
                                        <label htmlFor='floatingInput'>From</label>
                                    </div>
                                    <div className='form-floating'>
                                        <input className='form-control' id='floatingInput1' placeholder='To' />
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex align-items-center gap-10">
                                    ...
                                    <select name='' defaultValue={"manual"} className='form-control form-select' id=''>
                                        ...
                                        <option value="title-ascending">Alphabeltically, A-Z</option>
                                        <option value="title-descending">Alphabeltically, Z-A</option>
