                            ...
                            <div className="main-product-details">
                                ...
                                <div className="py-3">
                                    ...
                                    <div className='d-flex align-items-center gap-15 flex-row mt-2 mb-3'>
                                        ...
                                        <div className=''>
                                            <input type="number" className='form-control' min={1} max={10} name='' id='' style={{ width: "70px" }} />
                                        </div>
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className='bg-white p-3'>
                                <p>
                                    Lorem ipsum dolor, sit amet consectetur adpisiring us elit.
                                    Tenetur nisi similate ulism aunt prefered volusta
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="review-inner-wrapper">
                                ...
                                <div className="reviews mt-4">
                                    <div className="review">
                                        ...
                                        <p className='mt-3'>
                                            Lorem ipsum rosh dars ust ant sunre serie okras torr
                                        </p>
                                    </div>
                                </div>
                            </div>
