...
const SingleProduct = () =>
{
    ...
    const props = { width: 400, height: 600, zoomWidth: 600, img: productState?.images[0].url ? productState.images[0].url : "https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-fernando-arcos-190819.jpg&fm=jpg" };
                ...
                <div className="row">
                    <div className="col-6">
                        ...
                        <div className="other-product-images d-flex flex-wrap gap-15">
                            ...
                            {
                                return (
                                    <div key={index}><img src={item?.url} className='img-fluid' alt="" /></div>
                                )
                            })}
                        ...
                        <div className="main-product-details">
                            ...
                            <div className="py-3">
                                ...
                                <div className='d-flex gap-10 align-items-center my-3'>
                                    ...
                                    <a href="javasript:void(0)" onClick={() => { copyToClipboard(window.location.href); }}>
                                        Copy Product Link
                                    </a>
                                </div>
                            </div>
